...
public class FileController {
    ...
    @RequestMapping(value = "/funBlog/files", method = RequestMethod.GET)
    @ResponseBody
    public List<String> getAllFiles(HttpSession httpSession){
        return fileService.getAllFiles((String) httpSession.getAttribute("name"));
    }

    @RequestMapping(value = "/funBlog/folders", method = RequestMethod.GET)
    @ResponseBody
    public List<String> getAllFolders(HttpSession httpSession){
        return fileService.getAllFolders((String) httpSession.getAttribute("name"));
    }
}
